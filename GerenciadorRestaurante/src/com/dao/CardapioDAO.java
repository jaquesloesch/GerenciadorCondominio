...
public class CardapioDAO {
	 ...
	 */
	public boolean insere(Cardapio object) throws Exception {

		try {
			object.setId(getProximoId());
			StringBuilder sb = new StringBuilder();
			sb.append("INSERT INTO ").append(getTableName())
					.append("(ID,NOME,PRECO) VALUES(?,?,?);");
			...
			pst.setDouble(3, object.getPreco());
	 ...
	 */
	public boolean atualiza(Cardapio object) throws Exception {
	 ...
	 */
	public List<Cardapio> convertInObject(ResultSet rs) throws Exception {
		List<Cardapio> lista = new ArrayList<Cardapio>();
		try {

			while (rs.next()) {

				Cardapio user = new Cardapio();
				user.setId(new Integer(rs.getString("id") != null ? rs
						.getString("id") : "0"));
				user.setNome((rs.getString("NOME")));
				user.setPreco(rs.getDouble("PRECO"));
	...
	public void criarTabela() throws Exception {
		...
		sb.append(getTableName()).append("(")
				...
				.append("NOME text,").append("PRECO double,")
	 ...
	 * @throws Exception
	 */
	public boolean deleta(Cardapio object) throws Exception {
	 ...
	 * @throws Exception
	 */
	public List<Cardapio> getTodos() throws Exception {
	 ...
	 * @throws Exception
	 */
	public Cardapio procuraPeloId(Integer id) throws Exception {
	 ...
	 * @return
	 */
	public Cardapio executarComandoSelect(PreparedStatement ps)
			throws Exception {
	 ...
	 * @return
	 */
	public List<Cardapio> executaSelect(String comando) throws Exception {
